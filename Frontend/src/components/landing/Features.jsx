...
const Features = () => {
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto lg:px-8 relative">
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-gray-900 tracking-tighter ">
            {" "}
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Our platform is packed with features to help you wirte, design, and
            publish your ebook effortlessly.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((feature, index) => {
            ...
            return (
              <div
                className="group relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-r-violet-200 transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/10 hover:-translate-y-1"
                key={index}
              >
